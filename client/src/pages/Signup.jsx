    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Start protecting your freelance work today</p>
        </div>
        ...
        <p className="text-gray-500 text-center text-sm mt-5">
          ...
          <span onClick={() => navigate('/login')} className="text-purple-600 cursor-pointer font-medium">
            Login
          </span>
        </p>
      </div>
